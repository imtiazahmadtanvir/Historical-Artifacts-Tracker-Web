...
import { FaArrowRight, FaHeart, FaMapMarkerAlt, FaCalendarAlt } from "react-icons/fa"; // For icons
            ...
            {artifacts.map((artifact) => (
              ...
              >
                <div className="relative">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-white bg-opacity-75 px-3 py-1 rounded-full text-xs text-gray-800 font-semibold">
                    {artifact.location}
                  </div>
                </div>
                <div className="p-6">
