...
<footer className="bg-white dark:bg-gray-900 mx-auto">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-5 md:mb-0 sm:justify-center">
              <a href="https://flowbite.com/" className="flex items-center sm:justify-center sm:text-center w-full mx-auto">
                  ...
                  <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Historical Artifacts Tracker</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://flowbite.com/" className="hover:underline">Historical Artifacts Tracker</a>
                      </li>
                      <li>
      ...
      <div className="flex flex-col pb sm:items-center sm:justify-between sm:mx-auto text-center ">
          <div className="pb-4">
              <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Historical Artifacts Tracker </a>All Rights Reserved.
              </span>
          </div>
