    ...
    <section className="py-16">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center bg-white dark:bg-gray-800 p-6 shadow-xl rounded-lg transition-transform transform hover:scale-105">
        ...
        <div className="mt-10">
          <Link
            to="/all-artifacts"
            className="bg-yellow-400 text-black dark:text-white font-semibold py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors"
          >
